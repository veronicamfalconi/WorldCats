...
function Carrusel() {
    ...
    <Carousel.Item>
      ...
      <Carousel.Caption>
        <h3 className="fs-5 custom-italic">Según la ciencia ser amante de los gatos es bueno para la mente y el cuerpo</h3>
      </Carousel.Caption>
    </Carousel.Item>
    <Carousel.Item>
      <img fluid src={imagenDos} alt="Second slide" className="carousel-image" />
      <Carousel.Caption>
        <h3 className="fs-5 custom-italic">Son un antiestrés natural</h3>
    ...
    <Carousel.Item>
      ...
      <Carousel.Caption>
        <h3 className="fs-5 custom-italic">Ayuda a controlar las enfermedades cardíacas, los accidentes cerebrovasculares y los ataques cardíacos</h3>
        <p className="fs-5 custom-italic">
    ...
    <Carousel.Item>
      ...
      <Carousel.Caption>
        <h3 className="fs-5 custom-italic">Bajan la presión sanguínea</h3>
        <p className="fs-5 custom-italic">
    ...
    <Carousel.Item>
      ...
      <Carousel.Caption>
        <h3 className="fs-5 custom-italic">Ayudan a dormir mejor</h3>
        <p className="fs-5 custom-italic">
    ...
    <Carousel.Item>
      ...
      <Carousel.Caption>
        <h3 className="fs-5 custom-italic">Hacen bien a nuestros huesos</h3>
        <p className="fs-5 custom-italic">
    ...
    <Carousel.Item>
      ...
      <Carousel.Caption>
        <h3 className="fs-5 custom-italic">Potencian nuestro sistema inmunitario</h3>
        <p className="fs-5 custom-italic">
